...
<body>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-4 mb-4">
      <img class="card-img-top" src="./image/needblood.png" alt="Card image" style="width:100%;height: 400px;">
      </div>
    </div>
    <div class="row">
      <div class="col-lg-4 mb-4">
    ...
    <div class="row">
      <?php if(isset($_POST['search'])){
        ...
        //echo $bg;
        include 'conn.php';
        $sql= "select * from donor_details inner join blood where donor_details.donor_blood=blood.blood_id AND donor_details.donor_blood={$bg} order by rand() limit 5";
        $result=mysqli_query($conn,$sql) or die("query unsuccessful.");
