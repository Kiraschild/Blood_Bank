...
<body style="background-color:red;">
  ...
  <form class="" action="<?php $_SERVER['PHP_SELF']; ?>" method="post">
    ...
    <div class="container" style="margin-top:200px;">
      ...
      <div class="card" style="height:300px; background-image:url('admin_image/form.jpg');">
          <div class="card-body">
  ...
  <div class="row justify-content-lg-center justify-content-mb-center">
    ...
    <br>
    <br>
    <button class="btn btn-primary" ><a class ="f" href="http://localhost/BDMS/home.php">Go Back to Main Website</a></button>
    </div> 
