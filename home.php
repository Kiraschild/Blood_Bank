  ...
  <div id="demo" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="https://www.eraktkosh.in/BLDAHIMS/bloodbank/transactions/assets/webp/updated_NewYear2022.webp" width="100%">
      </div>
      <div class="carousel-item">
        <img src="https://www.eraktkosh.in/BLDAHIMS/bloodbank/transactions/assets/webp/ONE_NATION_2500_600.webp" alt="https://www.eraktkosh.in/BLDAHIMS/bloodbank/transactions/assets/webp/ONE_NATION_2500_600.webp" width="100%" >
      </div>
            ...
            <div class="col-lg-4 mb-4">
                <div class="card">
                    <h4 class="card-header card bg-info text-white" >The need for blood</h4>
                        ...
                        <p class="card-body overflow-auto" style="padding-left:2%;height:200px;text-align:left;">
                          <?php
                            include 'conn.php';
          ...
          <?php
           ...
           ?>
            ...
            <div class="card" style="width:300px">
                <img class="card-img-top" src="https://media.istockphoto.com/id/1221238134/vector/blood-drop-icon-silhouette.jpg?s=612x612&w=0&k=20&c=Q7Y_zmF1fMlG-O2PV8b-koq2CDjEnf6UR7jXxkdsTbk=" alt="Card image" style="width:100%;height:300px">
                <div class="card-body">
